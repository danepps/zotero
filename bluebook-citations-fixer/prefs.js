...
// Style sync (see lib/style-sync.js): keep the installed Epps Bluebook styles
// (the hard-wired built-ins in lib/patch.js) current. Checked at most once
// per 24h shortly after startup, plus on demand from the Settings pane. Never
// installs a style that isn't already installed. lastCheck is a ms-epoch
// STRING because Zotero prefs have no int64.
